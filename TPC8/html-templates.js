...
function fileList( files, d){
    ...
    pagHTML += `<tr><a href="/files/upload"><button type="button">Upload image</button></a></tr>`
    pagHTML += `
          </table>
          <div class="w3-container w3-teal">
              <address>Generated by gImagem::PRI2020 em ${d} --------------</address>
          </div>
      </body>
      </html>
    `
    ...
    <html>
        ...
        <body>
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por gImagem::PRI2020 em ${d}</address>
            </footer>
        </body>
    </html>
    `
